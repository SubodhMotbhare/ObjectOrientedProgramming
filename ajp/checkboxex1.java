...
Checkbox c1=new Checkbox("OSY",c);
Checkbox c2=new Checkbox("AJP",c);
Checkbox c3=new Checkbox("STE",c);
Checkbox c4=new Checkbox("EVN",c);
Checkbox c5=new Checkbox("ACN",c);
...
{
checkboxgroup1 c=new checkboxgroup();
}
}
